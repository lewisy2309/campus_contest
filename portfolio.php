...
<!-------------------------------------------------->
        ...
        <div class="division" id="portfolio">
            <h2>portfolio</h2>
            <div class="rangementhorizontal">
               <?php 
             $ajout_formationprojet= $db->query("SELECT * FROM projet ORDER BY id_projet ");
            while ($addproject = $ajout_formationprojet->fetch()){ ?>
                
            <div class="container" >
                <div class="card">
                    
                    <div class="frontcard">
                        <h3><?php echo $addproject["projet_nom"] ;?></h3>
                    </div>
                    
                    <div class="backcard">
                        <p><?php echo $addproject["projet_description"] ;?></p>
                        <button><a href="<?php echo "avisrecommandation.php?id_recommandation=".$addproject["id_projet"] ?>" >Laisser un avis</a></button>
                        <button><a href="<?php echo $addproject["projet_lien"] ?>">Voir le projet</a></button>
                    </div>
...
<!-------------------------------------------------->
        ...
        <div class="division mecontacter">
            <h2>me contacter</h2>
            <div>  
                <div>
                ...
                <section>
                    <img src="../img/phone_icon.png" alt="phone_icon"/><p> </p>
                </section>
                </div>
